...
/**
 * ST AIoT Craft info
 * Project name: test_tricep_curls
 * Project id: a48d9dad-0ca4-4a70-ba7f-6c055de3892f
 * Model name: tricep_curls
 * Model id: 71c8a58d-90fe-469c-b72c-3e139d540ed1
 */
...
static const char *const lsm6dsv16x_mlc_date = "2025-03-11 20:57:48";
...
static const struct mems_conf_result lsm6dsv16x_mlc_results_0_0[] = {
	{ .code = 0x00, .label = "tricep_curls_proper_form" },
	{ .code = 0x04, .label = "tricep_curls_improper_fo" }
};
...
static const struct mems_conf_fifo_encoding lsm6dsv16x_mlc_fifo_encodings_0[] = {
	{ .tag = 0x1C, .id = 0x0406, .label = "F1_MAXIMUM_ACC_Y" },
	{ .tag = 0x1C, .id = 0x0408, .label = "F2_POSITIVE_PEAK_DETECTOR_ACC_Z" },
	{ .tag = 0x1C, .id = 0x040A, .label = "F3_MEAN_ACC_Y" },
	{ .tag = 0x1C, .id = 0x040C, .label = "F4_MINIMUM_ACC_Y" },
	{ .tag = 0x1C, .id = 0x040E, .label = "F5_PEAK_TO_PEAK_ACC_Z" },
	{ .tag = 0x1C, .id = 0x0410, .label = "F6_ENERGY_GYR_X" },
	{ .tag = 0x1C, .id = 0x0412, .label = "F7_POSITIVE_PEAK_DETECTOR_ACC_X" },
	{ .tag = 0x1C, .id = 0x0414, .label = "F8_VARIANCE_ACC_Z" },
	{ .tag = 0x1C, .id = 0x0416, .label = "F9_MINIMUM_GYR_Z" },
	{ .tag = 0x1C, .id = 0x0418, .label = "F10_ABS_PEAK_TO_PEAK_GYR_V" },
	{ .tag = 0x1C, .id = 0x041A, .label = "F11_MINIMUM_ACC_Z" },
	{ .tag = 0x1C, .id = 0x041C, .label = "F12_MAXIMUM_ACC_Z" },
	{ .tag = 0x1C, .id = 0x041E, .label = "F13_MEAN_ACC_Z" },
	{ .tag = 0x1C, .id = 0x0420, .label = "F14_ABS_MEAN_ACC_V" },
	{ .tag = 0x1C, .id = 0x0422, .label = "F15_ABS_VARIANCE_ACC_V" },
	{ .tag = 0x1C, .id = 0x0424, .label = "F16_ABS_ENERGY_ACC_V" },
	{ .tag = 0x1C, .id = 0x0426, .label = "F17_ABS_PEAK_TO_PEAK_ACC_V" },
	{ .tag = 0x1C, .id = 0x0428, .label = "F18_ABS_MINIMUM_ACC_V" },
	{ .tag = 0x1C, .id = 0x042A, .label = "F19_PEAK_TO_PEAK_GYR_Z" },
	{ .tag = 0x1C, .id = 0x042C, .label = "F20_ENERGY_GYR_Z" },
	{ .tag = 0x1C, .id = 0x042E, .label = "F21_ABS_MEAN_GYR_V" },
	{ .tag = 0x1C, .id = 0x0430, .label = "F22_MAXIMUM_GYR_Z" },
	{ .tag = 0x1C, .id = 0x0432, .label = "F23_ENERGY_ACC_Z" },
	{ .tag = 0x1C, .id = 0x0434, .label = "F24_ABS_MINIMUM_GYR_V" },
	{ .tag = 0x1C, .id = 0x0436, .label = "F25_PEAK_TO_PEAK_GYR_Y" }
};
