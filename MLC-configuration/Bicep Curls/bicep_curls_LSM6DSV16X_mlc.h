...
/**
 * ST AIoT Craft info
 * Project name: test_curls
 * Project id: bddf64cc-445c-49fe-8777-60538251055f
 * Model name: bicep_curls_12-3-25
 * Model id: 47dd26c5-ab62-42a4-88d4-18b4585934f8
 */
...
static const char *const lsm6dsv16x_mlc_date = "2025-03-12 18:43:01";
...
static const struct mems_conf_result lsm6dsv16x_mlc_results_0_0[] = {
	{ .code = 0x00, .label = "Bicep_curl_proper_form" },
	{ .code = 0x04, .label = "Bicep_curl_improper_form" }
};
...
static const struct mems_conf_fifo_encoding lsm6dsv16x_mlc_fifo_encodings_0[] = {
	{ .tag = 0x1B, .id = 0x0460, .label = "FILTER_IIR2_ACC_V" },
	{ .tag = 0x1B, .id = 0x0462, .label = "FILTER_IIR2_GYRO_V" },
	{ .tag = 0x1C, .id = 0x0464, .label = "F1_ABS_MAXIMUM_ACC_V" },
	{ .tag = 0x1C, .id = 0x0466, .label = "F2_ABS_PEAK_TO_PEAK_ACC_V" },
	{ .tag = 0x1C, .id = 0x0468, .label = "F3_ENERGY_GYR_Y" },
	{ .tag = 0x1C, .id = 0x046A, .label = "F4_MAXIMUM_GYR_Y" },
	{ .tag = 0x1C, .id = 0x046C, .label = "F5_PEAK_TO_PEAK_GYR_Y" },
	{ .tag = 0x1C, .id = 0x046E, .label = "F6_MEAN_ACC_X" },
	{ .tag = 0x1C, .id = 0x0470, .label = "F7_ABS_ZERO_CROSSING_ACC_V" },
	{ .tag = 0x1C, .id = 0x0472, .label = "F8_ABS_PEAK_TO_PEAK_GYR_V" },
	{ .tag = 0x1C, .id = 0x0474, .label = "F9_MINIMUM_GYR_Z" },
	{ .tag = 0x1C, .id = 0x0476, .label = "F10_ZERO_CROSSING_ACC_X" },
	{ .tag = 0x1C, .id = 0x0478, .label = "F11_POSITIVE_PEAK_DETECTOR_GYR_X" },
	{ .tag = 0x1C, .id = 0x047A, .label = "F12_PEAK_DETECTOR_ACC_Y" },
	{ .tag = 0x1C, .id = 0x047C, .label = "F13_MEAN_ACC_Z" },
	{ .tag = 0x1C, .id = 0x047E, .label = "F14_NEGATIVE_ZERO_CROSSING_GYR_Y" },
	{ .tag = 0x1C, .id = 0x0480, .label = "F15_MEAN_GYR_Y" },
	{ .tag = 0x1C, .id = 0x0482, .label = "F16_ENERGY_GYR_X" },
	{ .tag = 0x1C, .id = 0x0484, .label = "F17_NEGATIVE_PEAK_DETECTOR_GYR_Z" },
	{ .tag = 0x1C, .id = 0x0486, .label = "F18_ABS_VARIANCE_ACC_V" },
	{ .tag = 0x1C, .id = 0x0488, .label = "F19_MINIMUM_GYR_X" },
	{ .tag = 0x1C, .id = 0x048A, .label = "F20_POSITIVE_ZERO_CROSSING_ACC_X" },
	{ .tag = 0x1C, .id = 0x048C, .label = "F21_ABS_POSITIVE_PEAK_DETECTOR_ACC_V" },
	{ .tag = 0x1C, .id = 0x048E, .label = "F22_ABS_MAXIMUM_ACC_V_FILTER_1" },
	{ .tag = 0x1C, .id = 0x0490, .label = "F23_ABS_ENERGY_ACC_V_FILTER_1" },
	{ .tag = 0x1C, .id = 0x0492, .label = "F24_ABS_PEAK_TO_PEAK_ACC_V_FILTER_1" },
	{ .tag = 0x1C, .id = 0x0494, .label = "F25_ABS_ENERGY_ACC_V_FILTER_1" },
	{ .tag = 0x1C, .id = 0x0496, .label = "F26_ABS_MAXIMUM_GYR_V_FILTER_2" },
	{ .tag = 0x1C, .id = 0x0498, .label = "F27_ABS_ENERGY_GYR_V_FILTER_2" },
	{ .tag = 0x1C, .id = 0x049A, .label = "F28_ABS_PEAK_TO_PEAK_GYR_V_FILTER_2" },
	{ .tag = 0x1C, .id = 0x049C, .label = "F29_ABS_ENERGY_GYR_V_FILTER_2" }
};
...
static const struct mems_conf_op lsm6dsv16x_mlc_conf_0[] = {
	...
	{ .type = MEMS_CONF_OP_TYPE_WRITE, .address = 0x09, .data = 0xBD },
	{ .type = MEMS_CONF_OP_TYPE_WRITE, .address = 0x09, .data = 0xB7 },
	{ .type = MEMS_CONF_OP_TYPE_WRITE, .address = 0x09, .data = 0x40 },
	{ .type = MEMS_CONF_OP_TYPE_WRITE, .address = 0x09, .data = 0xA5 },
	{ .type = MEMS_CONF_OP_TYPE_WRITE, .address = 0x09, .data = 0xD7 },
	{ .type = MEMS_CONF_OP_TYPE_WRITE, .address = 0x09, .data = 0x3C },
	{ .type = MEMS_CONF_OP_TYPE_WRITE, .address = 0x09, .data = 0x04 },
