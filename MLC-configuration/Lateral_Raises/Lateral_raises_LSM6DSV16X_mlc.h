...
/**
 * ST AIoT Craft info
 * Project name: Lateral_raises
 * Project id: d7ee9f5d-ff37-49ba-8661-d8b66c6ee8ba
 * Model name: Lateral_raises
 * Model id: 6e51ec76-6a86-4648-a4e8-fb358c848602
 */
...
static const char *const lsm6dsv16x_mlc_date = "2025-03-11 17:16:54";
...
static const struct mems_conf_result lsm6dsv16x_mlc_results_0_0[] = {
	{ .code = 0x00, .label = "lr_improper_form" },
	{ .code = 0x04, .label = "lr_proper_form" }
};
...
static const struct mems_conf_fifo_encoding lsm6dsv16x_mlc_fifo_encodings_0[] = {
	{ .tag = 0x1C, .id = 0x03C6, .label = "F1_MAXIMUM_ACC_Z" },
	{ .tag = 0x1C, .id = 0x03C8, .label = "F2_ABS_VARIANCE_GYR_V" },
	{ .tag = 0x1C, .id = 0x03CA, .label = "F3_MAXIMUM_GYR_Z" },
	{ .tag = 0x1C, .id = 0x03CC, .label = "F4_MINIMUM_GYR_Y" },
	{ .tag = 0x1C, .id = 0x03CE, .label = "F5_ABS_MAXIMUM_GYR_V" },
	{ .tag = 0x1C, .id = 0x03D0, .label = "F6_ENERGY_GYR_Y" },
	{ .tag = 0x1C, .id = 0x03D2, .label = "F7_MEAN_GYR_Y" },
	{ .tag = 0x1C, .id = 0x03D4, .label = "F8_MAXIMUM_ACC_Y" },
	{ .tag = 0x1C, .id = 0x03D6, .label = "F9_MEAN_GYR_Z" },
	{ .tag = 0x1C, .id = 0x03D8, .label = "F10_PEAK_TO_PEAK_GYR_Y" },
	{ .tag = 0x1C, .id = 0x03DA, .label = "F11_ENERGY_GYR_Z" },
	{ .tag = 0x1C, .id = 0x03DC, .label = "F12_VARIANCE_GYR_Z" },
	{ .tag = 0x1C, .id = 0x03DE, .label = "F13_ABS_MINIMUM_GYR_V" },
	{ .tag = 0x1C, .id = 0x03E0, .label = "F14_MINIMUM_GYR_Z" },
	{ .tag = 0x1C, .id = 0x03E2, .label = "F15_ABS_PEAK_TO_PEAK_GYR_V" }
};
